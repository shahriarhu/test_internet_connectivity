...
import 'package:test_first/simple_notification_widget.dart';
import 'package:test_first/test_view.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    simpleNotificationWidget(message: 'Increment successful');
    setState(() {
